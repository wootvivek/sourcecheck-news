...
const LOADING_MESSAGES = [
  ...
  "Checking what 184 sources agree on…",
  "Making sense of it all…",
  "Aggregating with extreme prejudice (against bad takes)…",
  "Interviewing electrons for the latest scoop…",
];
